...
from .settings import GridSettings, LayoutSettings, OrthogonalSettings, TopologicalSettings
...
def layout(
    ...
    *,
    ...
    settings: LayoutSettings | TopologicalSettings | GridSettings | OrthogonalSettings | None = None,
) -> None:
    """
